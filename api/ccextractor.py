...
_ccextractor.EXIT_OK_swigconstant(_ccextractor)
EXIT_OK = _ccextractor.EXIT_OK

_ccextractor.EXIT_NO_INPUT_FILES_swigconstant(_ccextractor)
EXIT_NO_INPUT_FILES = _ccextractor.EXIT_NO_INPUT_FILES

_ccextractor.EXIT_TOO_MANY_INPUT_FILES_swigconstant(_ccextractor)
EXIT_TOO_MANY_INPUT_FILES = _ccextractor.EXIT_TOO_MANY_INPUT_FILES

_ccextractor.EXIT_INCOMPATIBLE_PARAMETERS_swigconstant(_ccextractor)
EXIT_INCOMPATIBLE_PARAMETERS = _ccextractor.EXIT_INCOMPATIBLE_PARAMETERS

_ccextractor.EXIT_UNABLE_TO_DETERMINE_FILE_SIZE_swigconstant(_ccextractor)
EXIT_UNABLE_TO_DETERMINE_FILE_SIZE = _ccextractor.EXIT_UNABLE_TO_DETERMINE_FILE_SIZE

_ccextractor.EXIT_MALFORMED_PARAMETER_swigconstant(_ccextractor)
EXIT_MALFORMED_PARAMETER = _ccextractor.EXIT_MALFORMED_PARAMETER

_ccextractor.EXIT_READ_ERROR_swigconstant(_ccextractor)
EXIT_READ_ERROR = _ccextractor.EXIT_READ_ERROR

_ccextractor.EXIT_WITH_HELP_swigconstant(_ccextractor)
EXIT_WITH_HELP = _ccextractor.EXIT_WITH_HELP

_ccextractor.EXIT_NO_CAPTIONS_swigconstant(_ccextractor)
EXIT_NO_CAPTIONS = _ccextractor.EXIT_NO_CAPTIONS

_ccextractor.EXIT_NOT_CLASSIFIED_swigconstant(_ccextractor)
EXIT_NOT_CLASSIFIED = _ccextractor.EXIT_NOT_CLASSIFIED

_ccextractor.EXIT_ERROR_IN_CAPITALIZATION_FILE_swigconstant(_ccextractor)
EXIT_ERROR_IN_CAPITALIZATION_FILE = _ccextractor.EXIT_ERROR_IN_CAPITALIZATION_FILE

_ccextractor.EXIT_BUFFER_FULL_swigconstant(_ccextractor)
EXIT_BUFFER_FULL = _ccextractor.EXIT_BUFFER_FULL

_ccextractor.EXIT_MISSING_ASF_HEADER_swigconstant(_ccextractor)
EXIT_MISSING_ASF_HEADER = _ccextractor.EXIT_MISSING_ASF_HEADER

_ccextractor.EXIT_MISSING_RCWT_HEADER_swigconstant(_ccextractor)
EXIT_MISSING_RCWT_HEADER = _ccextractor.EXIT_MISSING_RCWT_HEADER

_ccextractor.CCX_COMMON_EXIT_FILE_CREATION_FAILED_swigconstant(_ccextractor)
CCX_COMMON_EXIT_FILE_CREATION_FAILED = _ccextractor.CCX_COMMON_EXIT_FILE_CREATION_FAILED

_ccextractor.CCX_COMMON_EXIT_UNSUPPORTED_swigconstant(_ccextractor)
CCX_COMMON_EXIT_UNSUPPORTED = _ccextractor.CCX_COMMON_EXIT_UNSUPPORTED

_ccextractor.EXIT_NOT_ENOUGH_MEMORY_swigconstant(_ccextractor)
EXIT_NOT_ENOUGH_MEMORY = _ccextractor.EXIT_NOT_ENOUGH_MEMORY

_ccextractor.CCX_COMMON_EXIT_BUG_BUG_swigconstant(_ccextractor)
CCX_COMMON_EXIT_BUG_BUG = _ccextractor.CCX_COMMON_EXIT_BUG_BUG

_ccextractor.CCX_OK_swigconstant(_ccextractor)
CCX_OK = _ccextractor.CCX_OK

_ccextractor.CCX_FALSE_swigconstant(_ccextractor)
CCX_FALSE = _ccextractor.CCX_FALSE

_ccextractor.CCX_TRUE_swigconstant(_ccextractor)
CCX_TRUE = _ccextractor.CCX_TRUE

_ccextractor.CCX_EAGAIN_swigconstant(_ccextractor)
CCX_EAGAIN = _ccextractor.CCX_EAGAIN

_ccextractor.CCX_EOF_swigconstant(_ccextractor)
CCX_EOF = _ccextractor.CCX_EOF

_ccextractor.CCX_EINVAL_swigconstant(_ccextractor)
CCX_EINVAL = _ccextractor.CCX_EINVAL

_ccextractor.CCX_ENOSUPP_swigconstant(_ccextractor)
CCX_ENOSUPP = _ccextractor.CCX_ENOSUPP

_ccextractor.CCX_ENOMEM_swigconstant(_ccextractor)
